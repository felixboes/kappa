...
MatrixBool::MatrixBool( size_t number_rows, size_t number_cols ) : data( number_rows, boost::dynamic_bitset<>(num_cols, 0) ), num_rows(number_rows), num_cols(number_cols)
{
}
