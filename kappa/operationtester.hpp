...
public:
    ...
    // radial, g, m, p
    typedef std::tuple< bool, uint32_t, uint32_t, int32_t  > EhrIndex;
     ...
     */
    bool load_basis( const EhrIndex& idx, bool print_status_messages = true );
    /**
     *  Tries to load a given basis.
     *  @returns true on success.
     */
     ...
     */ 
    size_t dim( const EhrIndex& idx ) const;
    /**
     *  @returns the dimension of a given basis.
     */ 
     ...
     *  Free given data.
     */
    void forget_basis( const EhrIndex& idx );
    /**
     *  Free given data.
     */
     ...
     *  @returns true on success.
     */
    bool load_base_changes( const EhrIndex& idx, bool print_status_messages = true );
    /**
     *  Tries to load a given base change.
     *  @returns true on success.
     */
     ...
     *  Free given data.
     */
    void forget_base_changes( const EhrIndex& idx );
    /**
     *  Free given data.
     */
     ...
     *  @returns true on success.
     */
    bool load_triangular( const EhrIndex& idx, bool print_status_messages = true );
    /**
     *  Tries to load a given triangular matrix.
     *  @returns true on success.
     */
     ...
     *  Free given data.
     */
    void forget_triangular( const EhrIndex& idx );
    /**
     *  Free given data.
     */
     ...
     *  @returns true on success.
     */
    bool load_diagonal( const EhrIndex& idx, bool print_status_messages = true );
    /**
     *  Tries to load a given diagonal.
     *  @returns true on success.
     */
     ...
     *  Free given data.
     */
    void forget_diagonal( const EhrIndex& idx );
    /**
     *  Free given data.
     */
     ...
     */
    bool vector_is_valid( const EhrIndex& idx, const VectorType& v ) const;
    
    /**
     *  @returns true iff the chain is a cycle. Tries to load matrix.
     */
    bool vector_is_cycle( const EhrIndex& idx, const VectorType& v );
    
//    /**
//     *  @returns the given homology class of the vector v.
//     *  @warning We assert, that p >= 2 and v is valid cycle.
//     */
//    VectorType vector_homology_class( const EhrIndex& idx, const VectorType& v );
    
    /**
     *  @returns the index of the associated moduli space.
     */
    static EhrIndex  product( const EhrIndex& idx_v, const EhrIndex& idx_w );
    
    /**
     *  @returns the product of two vectors in he associated moduli space.
     */
    VectorType product( const EhrIndex& idx_v, const VectorType& v, const EhrIndex& idx_w, const VectorType& w );
    
//    /**
//     *  @returns Q(v).
//    **/
//    VectorType Q( const EhrIndex& idx_v, const VectorType& v );
    
//    /**
//     *  compute and add Q of a single tuple to a given vector.
//    **/
//    void compute_and_add_Q( const CoefficientType& c, const SymGrpTuple& t, const EhrBasis& b, VectorType v );
...
public:
     ...
     *  @returns true iff the number of entries of v is the number of basis elements.
     */
    bool vector_is_valid( const CSSIndex& ehrindex, const VectorType& v ) const;
    bool vector_is_cycle( const CSSIndex& ehrindex, const VectorType& v ) const;
